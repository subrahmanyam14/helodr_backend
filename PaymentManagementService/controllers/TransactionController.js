...
const getDoctorCreditedTransactions = async (req, res) => {
  try {
...
const getDoctorTransactionAnalysis = async (req, res) => {
  try {
    const doctorId = req.user.doctorId;
    const userId = req.user._id;
...
const getAvailableForWithdrawal = async (req, res) => {
  try {
    const userId = req.user._id;
    const doctorId = req.user.doctorId;
...
module.exports = {
  ...
  getPaymentDashboard,
  getDoctorCreditedTransactions,
  getDoctorTransactionAnalysis,
